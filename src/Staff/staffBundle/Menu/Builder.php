...
namespace Staff\staffBundle\Menu;
...
class Builder extends ContainerAware
{
    public function mainMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('Entrée 1', array('route' => 'Staffstaff_homepage'))
            ->addChild('Entrée 1.1', array('route' => 'Staffstaff_personne'))
            ->addChild('Entrée 1.1.1', array('route' => 'Staffstaff_personne_service'));
