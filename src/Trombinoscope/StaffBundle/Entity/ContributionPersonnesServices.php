 ...
 * @ORM\Entity(repositoryClass="Trombinoscope\StaffBundle\Repository\ContributionPersonnesServiesRepository")
 * Created by PhpStorm.
 * User: kawtar
 * Date: 08/04/15
 * Time: 16:25
...
class ContributionPersonnesServices
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Trombinoscope\StaffBundle\Entity\Personnes", inversedBy="contributions")
     * @ORM\JoinColumn(name="Personne", referencedColumnName="Id", nullable=false)
     */
    private $personne;

    /**
     * @ORM\ManyToOne(targetEntity="Trombinoscope\StaffBundle\Entity\Services")
