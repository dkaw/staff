...
namespace Trombinoscope\StaffBundle\DataFixtures\ORM;
...
class LoadAttributsData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function getFixturesFiles()
    {
        ...
        return array(
            //referential data
            $bundles['TrombinoscopeStaffBundle']->getPath() . '/Resources/fixtures/Personnes.yml',
            $bundles['TrombinoscopeStaffBundle']->getPath() . '/Resources/fixtures/Pole.yml',
            $bundles['TrombinoscopeStaffBundle']->getPath() . '/Resources/fixtures/Services.yml',
            $bundles['TrombinoscopeStaffBundle']->getPath() . '/Resources/fixtures/Sites.yml',
            $bundles['TrombinoscopeStaffBundle']->getPath() . '/Resources/fixtures/ContributionauService.yml'
